...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create FFDiscordBot-7704
  fly apps create FFDiscordBot-7704-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app FFDiscordBot-7704
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app FFDiscordBot-7704-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'FFDiscordBot-7704-staging' does not match app name in config file 'FFDiscordBot-7704'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name FFDiscordBot-7704-db
  fly postgres attach --app FFDiscordBot-7704 FFDiscordBot-7704-db

  fly postgres create --name FFDiscordBot-7704-staging-db
  fly postgres attach --app FFDiscordBot-7704-staging FFDiscordBot-7704-staging-db
  ```
